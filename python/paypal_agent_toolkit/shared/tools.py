...
tools = [
    ...
    },
    {
        ...
        "description": GET_RECURRING_SERIES_PROMPT.strip(),
        "args_schema": GetRecurringSeriesParameters,
        "actions": {"invoices": {"getRecurringSeries": True}},
        "execute": get_recurring_series,
    },
    {
        "method": "cancel_recurring_series",
        "name": "Cancel Recurring Invoice Series",
        "description": CANCEL_RECURRING_SERIES_PROMPT.strip(),
        "args_schema": CancelRecurringSeriesParameters,
        "actions": {"invoices": {"cancelRecurringSeries": True}},
        "execute": cancel_recurring_series,
    },
    {
        "method": "delete_recurring_series",
        "name": "Delete Recurring Invoice Series",
        "description": DELETE_RECURRING_SERIES_PROMPT.strip(),
        "args_schema": DeleteRecurringSeriesParameters,
        "actions": {"invoices": {"deleteRecurringSeries": True}},
        "execute": delete_recurring_series,
    },
    {
    ...
    },
    {
        ...
        "name": "Delete Invoice",
        "description": DELETE_INVOICE_PROMPT.strip(),
        "args_schema": DeleteInvoiceParameters,
        "actions": {"invoices": {"delete": True}},
    ...
    },
    {
        ...
        "args_schema": SetupInvoiceAutoReminderParameters,
        "actions": {"invoices": {"setupReminders": True}},
        "execute": setup_invoice_auto_reminders,
    },
    {
        "method": "update_invoice_auto_reminder",
        "name": "Update Invoice Auto Reminder",
        "description": UPDATE_INVOICE_AUTO_REMINDER_PROMPT.strip(),
