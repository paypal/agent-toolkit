...
export const listPaymentLinksPrompt = (context: Context) => `
...
export const getPaymentLinkPrompt = (context: Context) => `
...
export const updatePaymentLinkPrompt = (context: Context) => `
...
export const deletePaymentLinkPrompt = (context: Context) => `
